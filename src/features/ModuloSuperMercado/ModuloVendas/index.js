            ...
            <TitleCard title="Carrinho De Compras" topMargin="mt-2">
                ...
                <div className="mt-6 flex">
                    <input
                        ...
                        className="input input-bordered w-full max-w-xs mr-2" // Adiciona margem à direita
                    />
                    <input
                        type="number"
                        ...
                        className="input input-bordered w-full max-w-xs mr-2" // Adiciona margem à direita
                    />
                    <button className="btn btn-primary" onClick={addProductToList}>
                        Adicionar produto
                    </button>
                </div>
                    ...
                    <table class="printer-ticket">
                        ...
                        <tfoot>
                            ...
                            <tr class="ttu">
                                ...
                                <td align="right">R${dadosCadastradoCarrinho.valorTotal}</td>
                            </tr>
                            <tr class="ttu">
